...
topics: ["Telemetry Pipeline", "Data Processing", "ClickHouse", "Kafka", "Scalability"]
tags: ["telemetry", "data-pipeline", "clickhouse", "kafka", "scalability", "architecture"]
entities: ["Stefan", "Dustin", "Cosmo", "ClickHouse", "Kafka", "ClickHouse Cloud"]
mentions: ["telemetry pipeline", "schema usage data", "batching", "collectors", "back pressure", "Click Pipes"]
summary: "Dustin explains the telemetry pipeline architecture he built for Cosmo, including batching at the router level, using Kafka as a buffer between collectors and ClickHouse, and implementing back pressure mechanisms to handle high-scale data processing efficiently."
---
