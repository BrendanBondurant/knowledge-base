...
topics: ["Introduction", "Career Background", "GraphQL", "Open Source"]
tags: ["introduction", "career", "graphql", "open-source", "wundergraph"]
entities: ["Dustin", "Stefan", "Jens", "WunderGraph", "High Graph", "RTL", "Fastly"]
mentions: ["CTO", "co-founder", "GraphQL federation", "content management system", "Rust", "edge computing"]
summary: "Stefan introduces Dustin as the CTO and co-founder of WunderGraph, replacing Jens for this episode. Dustin shares his career journey from computer science studies to working at High Graph on GraphQL content federation and RTL on GraphQL gateways, leading to his role at WunderGraph."
---
